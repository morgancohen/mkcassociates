                ...
                for ($xx = 0; $xx < sizeof($ii_answer->item_array); $xx++) {
					...
					if (!empty($comm)) {
						if (!$commentNamePrinted) {
							echo "<div class=\"comments-header\">". htmlspecialchars($print_options->commentName)."</div>\r<br/>";
